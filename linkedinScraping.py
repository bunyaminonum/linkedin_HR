...
driver = webdriver.Chrome("/path")  # mention chromedriver's path inside the quotes
...
username.send_keys('19701023@mersin.edu.tr')  # Your log-in Email

# locate password form by_class_name
password = driver.find_element_by_xpath('//*[@type="password"]')
# send_keys() to simulate key strokes
password.send_keys('19074747fb')  # Your password
...
link = 'profile-link'  # Profile link which you want to scrape
driver.get(link)
driver.implicitly_wait(1)
